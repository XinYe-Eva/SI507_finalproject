...
##### encoding: utf-8             ####
######################################
#It's the python file used for scratching data and creating cache, the results of this file has already saved as 'cache_yelp.json'.
...
#define the states and restaurant types
...
########################################
#### Part2: Use Web API to get data
########################################

########################################
#### Part2.1: Use YELP API
########################################

#Define headers of YELP API
...
##############################################################################
#### Part3: fetch data and organize them into a new tree, save as a josn
##############################################################################
...
for item in list_of_state:
    ...
    #record the image link of this record => node1
    #Here I use re to get the different url link for every state's map, I didn't use any API.
    ...
    #record the restaurant of this record => node2
    dic_of_state_res={}
